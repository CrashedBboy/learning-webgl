...
// rotation degree of square
var squareRotation = 0.0;

// time which we last animated
var then = 0;
...
function drawScene(gl, programInfo, buffers, deltaTime) {
    ...
    // (destination matrix, matrix to rotate, amount to rotate in radians, axis to rotate around)
...
function render(now) {
    ...
    drawScene(gl, programInfo, initBuffer(gl), deltaTime);
